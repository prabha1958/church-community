...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        return response()->json([
            ...
            'birthday_last_run' => DB::connection('tenant')
                ->table('system_runs')
                ->where('type', 'birthday')
                ->orderByDesc('last_run_at')
                ->value('last_run_at'),

            'anniversary_last_run' => DB::connection('tenant')
                ->table('system_runs')
